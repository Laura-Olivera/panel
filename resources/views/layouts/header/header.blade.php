			...
			<div class="dropdown">
				...
				<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
					...
					<div class="row row-paddingless">
						<!--begin:Item-->
						<div class="col-6">
							<a href="{{ URL::to('perfil') }}" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
								<span class="svg-icon svg-icon-3x svg-icon-success">
									<i class="icon-2x fas fa-user-circle text-primary"></i>
								</span>
								<span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Perfil</span>
							</a>
						</div>
						<!--end:Item-->
						<!--begin:Item-->
						<div class="col-6">
							<a href="{{ url('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="d-block py-10 px-5 text-center bg-hover-light">
								<span class="svg-icon svg-icon-3x svg-icon-success">
									<i class="icon-2x fas fa-sign-out-alt text-dark"></i>
								</span>
								<span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Salir</span>
							</a>

<div class="dropdown dropdown-inline mr-2">
    ...
    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
        ...
        <ul class="navi flex-column navi-hover py-2">
            ...
            <li class="navi-item">
                <a href="{{ route('exportarPdf', ['class' => $class, 'filename' => $filename]) }}" class="navi-link">
            ...
            <li class="navi-item">
                <a href="{{ route('exportarExcel', ['class' => $class, 'filename' => $filename]) }}" class="navi-link">
                    <span class="navi-icon">
            ...
            <li class="navi-item">
                <a href="{{ route('descargarDocumento', ['path' => Crypt::encryptString('assets\media\plantillas'),'name' => $plantilla]) }}" class="navi-link">
                    <span class="navi-icon">

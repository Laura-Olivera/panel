...
<div class="form-group row mt-3">
 					  			<label class="col-lg-1 col-form-label text-right">Primer apellido:</label>
 					  			<div class="col-lg-3">
 					   				<input type="text" class="form-control" placeholder="Enter contact number" id="pApellido" name="pApellido"/>
 					  			</div>
								<label class="col-lg-1 col-form-label text-right">Segundo apellido:</label>
 					  			<div class="col-lg-3">
 					   				<input type="text" class="form-control" placeholder="Enter contact number" id="sApellido" name="sApellido"/>
 					  			</div>
 					 		</div>
							<div class="form-group row">
 					  			<label class="col-lg-2 col-form-label text-right">Correo electrónico:</label>
								<div class="col-lg-3">
   								 	<input type="email" class="form-control" placeholder="Enter full name" id="email" name="email"/>
   								</div>
 					  			<label class="col-lg-2 col-form-label text-right">Contraseña:</label>
 					  			<div class="col-lg-3">
   								 	<input type="password" class="form-control" placeholder="Enter full name" id="password" name="password"/>
   								</div>
 					 		</div>
 					 		<div class="form-group row">
 					  			<label class="col-lg-2 col-form-label text-right">Calle:</label>
								<div class="col-lg-3">
   								 	<input type="text" class="form-control" placeholder="Enter full name" id="calle" name="calle"/>
   								</div>
 					  			<label class="col-lg-2 col-form-label text-right">Municipio:</label>
 					  			<div class="col-lg-3">
   								 	<input type="text" class="form-control" placeholder="Enter full name" id="municipio" name="municipio"/>
   								</div>
 					 		</div>
							<div class="form-group row">
 					  			<label class="col-lg-2 col-form-label text-right">Estado:</label>
								<div class="col-lg-3">
   								 	<input type="text" class="form-control" placeholder="Enter full name" id="estado" name="estado"/>
   								</div>
 					  			<label class="col-lg-2 col-form-label text-right">C.P:</label>
 					  			<div class="col-lg-3">
   								 	<input type="text" class="form-control" placeholder="Enter full name" id="postal" name="postal"/>
   								</div>
 					 		</div>
 					 		<div class="form-group row">
 					  			<label class="col-lg-2 col-form-label text-right">Telefono:</label>
								<div class="col-lg-3">
   								 	<input type="text" class="form-control" placeholder="Enter full name" id="telefono" name="telefono"/>
   								</div>
 					  			<label class="col-lg-2 col-form-label text-right">Perfil:</label>
 					  			<div class="col-lg-3">
								   <select class="form-control select2" id="kt_select2_1" name="param" id="perfil" name="perfil">

		...
		<div class="card card-custom">
			...
			<div class="card-header flex-wrap border-0 pt-6 pb-0">
				...
				<div class="card-toolbar">
					<!--begin::Button-->
					<a href="javascript:void(0);" onclick="add_tarea_modal();" class="btn btn-primary font-weight-bolder">
                ...
                <table id="tareas-table" name="tareas-table" class="table table-striped- table-bordered table-hover table-checkable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{statusToString($tarea->estatus)}}</td>
                            <td>
                                <a class="btn btn-elevate kt-font-brand" href="javascript:void(0);" onclick="edit_tarea_modal({{ $tarea->id }});" title="Editar"><i class="icon-xl far fa-edit"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
